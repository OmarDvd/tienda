...
//actualizamos el precio final
                ...
                peliculas.innerHTML += `	<div class="carritoTarjeta" id="carritoTarjeta${datos.id}">
                        ...
                        <button type="button" onClick="sumaleUno(${datos.id})">Sumar: </button>

                        <input type="number" id="cantidad" min="2" value="2" />
                        <button type="button" onClick="sumaleUno(${datos.id},1)">Sumar solo uno</button>

                        <button type="button" onClick="restaleUno(${datos.id})">Quitar: </button>

                        <input type="number" id="eliminar" min="1" value="1" max="${cantidad}"/>
                        <button type="button" onClick="restaleUno(${datos.id},1)">Quitar solo uno</button>
